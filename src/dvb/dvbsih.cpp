 ...
 * to integrate into tvheadend by Adam Sutton <dev@adamsutton.me.uk>, then
 * minor modifications for use in kaffeine.
 *
...
int freesat_huffman_decode
  (const uint8_t *src, size_t srclen, std::string& dst)
{
...
#if 0
std::string freesat_huffman_decode2(const unsigned char* str)
{
    std::string decoded;
    size_t e = freesat_huffman_decode(str, strlen((char*) str), decoded);
    assert(!e);
    return decoded;
}
...
int main()
{
    unsigned char a[] = {0x1f, 0x01, 0xd9, 0xaf, 0xd8, 0xab, 0xeb, 0x0f, 0x1f, 0x3b, 0xe4, 0xcc, 0};
    unsigned char b[] = {0x1f, 0x02, 0x57, 0x3c, 0x95, 0xd3, 0x5b, 0xf4, 0x27, 0xa1, 0x7d, 0x57, 0x4d, 0xec, 0x78, 0xed, 0xfc, 0x73, 0xc9, 0x6e, 0xab, 0x57, 0xad, 0x78, 0xce, 0xf6, 0x6d, 0x66, 0x9f, 0x00, 0x74, 0x40, 0};
    unsigned char c[] = {0x1f, 0x02, 0xe5, 0x61, 0x6d, 0x94, 0xb0, 0x04, 0xfe, 0x6e, 0x3b, 0x3b, 0x27, 0xf6, 0x6e, 0xd2, 0x97, 0xe8, 0x60, 0};
    unsigned char d[] = {0x1f, 0x02, 0x20, 0xbc, 0x35, 0xe1, 0xdb, 0x2e, 0x7f, 0x66, 0xcb, 0xd2, 0xf3, 0xfc, 0x74, 0xde, 0x53, 0xdd, 0xbb, 0x60, 0x4a, 0xe7, 0xe2, 0xfa, 0xd3, 0x26, 0xf6, 0xe7, 0xbb, 0x0c, 0x23, 0x65, 0x19, 0xd4, 0xf4, 0x4f, 0x0f, 0xdd, 0x0a, 0xbc, 0xca, 0x0d, 0x5f, 0x1f, 0x89, 0x4a, 0x03, 0xed, 0xb2, 0x96, 0x00, 0x9f, 0x96, 0xfc, 0};
    char* out = NULL;
    size_t* out_len = 0;
    
    std::cout << freesat_huffman_decode2(a) << "\n";
    std::cout << freesat_huffman_decode2(b) << "\n";
    std::cout << freesat_huffman_decode2(c) << "\n";
    std::cout << freesat_huffman_decode2(d) << "\n";
    return 0;
}
#endif
