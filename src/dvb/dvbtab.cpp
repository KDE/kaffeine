	...
	mediaWidget(mediaWidget_)
{
	...
	QAction *channelsAction = new QAction(KIcon(QLatin1String("video-television")), i18n("Channels"), this);
	...
	QAction *epgAction = new QAction(KIcon(QLatin1String("view-list-details")), i18n("Program Guide"), this);
	...
	QAction *osdAction = new QAction(KIcon(QLatin1String("dialog-information")), i18n("OSD"), this);
	...
	QAction *recordingsAction = new QAction(KIcon(QLatin1String("view-pim-calendar")),
	...
	instantRecordAction = new QAction(KIcon(QLatin1String("document-save")), i18n("Instant Record"), this);
	...
	QAction *configureAction = new QAction(KIcon(QLatin1String("configure")),
